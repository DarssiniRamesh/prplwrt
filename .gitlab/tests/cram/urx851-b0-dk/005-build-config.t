...
Assure expected build configuration (PCF-1413):
  ...
  CONFIG_TARGET_DEVICE_PACKAGES_intel_x86_lgm_DEVICE_PRPL_OSP_TB341=""
  CONFIG_DEVEL=y
  ...
  CONFIG_GPON_OMCI_ONU_CLI_PIPE=y
  CONFIG_GPON_OMCI_ONU_DEBUG_PRINTS=y
  CONFIG_GPON_OMCI_ONU_FORMATTED_OMCI_DUMP=y
  CONFIG_GPON_OMCI_ONU_MCC=y
  CONFIG_GPON_OMCI_ONU_PM=y
  CONFIG_GPON_OMCI_ONU_SELF_DESCRIPTION=y
  CONFIG_GPON_OMCI_ONU_UBUS_INTERFACE=y
  CONFIG_GPON_OMCI_ONU_UCI=y
  ...
  CONFIG_KERNEL_GIT_REF="updk_9.1.60_openwrt_23.05"
  ...
  CONFIG_PACKAGE_gpon-omci-onu=y
  ...
  CONFIG_PACKAGE_kmod-qos-mgr-drv=y
  ...
  CONFIG_PACKAGE_libmcastdaemon=y
  CONFIG_PACKAGE_libmcastfapi=y
  ...
  CONFIG_PACKAGE_mcast_service=y
  CONFIG_PACKAGE_mcastcli=y
  ...
  CONFIG_PACKAGE_secure_upgrade_utils=y
  ...
  CONFIG_PRPL_CONTROLLER_ROOT_PATH="X_PRPLWARE-COM_Controller"
  ...
  CONFIG_SAH_AMX_TR181_DEVICE_RESET_HARD_ENABLE=y
