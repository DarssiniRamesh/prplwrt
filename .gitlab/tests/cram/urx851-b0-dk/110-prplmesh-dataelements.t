...
First call of AccessPointCommit, controller should push empty config to agents:
  ...
  $ R "ubus -S call X_PRPLWARE-COM_Controller.Network AccessPointCommit"
  {"retval":""}
  {}
  {"amxd-error-code":0}
...
Create instances of Network.AccessPoint and push them to the agent:
  ...
  $ R "ubus -S call X_PRPLWARE-COM_Controller.Network.AccessPoint _add"
  {"object":"X_PRPLWARE-COM_Controller.Network.AccessPoint.1.","index":1,"name":"1","parameters":{},"path":"X_PRPLWARE-COM_Controller.Network.AccessPoint.1."}
  {}
  {"amxd-error-code":0}

Since no persistent storage of NbAPI Network subsection, always index:1 after controller restart:

  $ R "ubus -S call X_PRPLWARE-COM_Controller.Network.AccessPoint.1 _set '{\"parameters\":{\"Band2_4G\":1,\"Band5GH\":1,\"Band5GL\":1,\"Band6G\":1}}'"
  {"X_PRPLWARE-COM_Controller.Network.AccessPoint.1.":{"Band5GH":true,"Band6G":true,"Band5GL":true,"Band2_4G":true}}
  {}
  {"amxd-error-code":0}

  $ R "ubus -S call X_PRPLWARE-COM_Controller.Network.AccessPoint.1 _set '{\"parameters\":{\"MultiApMode\":\"Fronthaul+Backhaul\"}}'"
  {"X_PRPLWARE-COM_Controller.Network.AccessPoint.1.":{"MultiApMode":"Fronthaul+Backhaul"}}
  {}
  {"amxd-error-code":0}

  $ R "ubus -S call X_PRPLWARE-COM_Controller.Network.AccessPoint.1.Security _set '{\"parameters\":{\"ModeEnabled\":\"WPA2-Personal\",\"KeyPassphrase\":\"password\"}}'"
  {"X_PRPLWARE-COM_Controller.Network.AccessPoint.1.Security.":{"KeyPassphrase":"password","ModeEnabled":"WPA2-Personal"}}
  {}
  {"amxd-error-code":0}

  $ R "ubus -S call X_PRPLWARE-COM_Controller.Network.AccessPoint.1 _set '{\"parameters\":{\"SSID\":\"prplOSpriv\"}}'"
  {"X_PRPLWARE-COM_Controller.Network.AccessPoint.1.":{"SSID":"prplOSpriv"}}
  {}
  {"amxd-error-code":0}

In case the controller does not yet have this parameter, catch error here isof later during teardown test:
  $ R "ubus -S call X_PRPLWARE-COM_Controller.Network.AccessPoint.1 _set '{\"parameters\":{\"Enable\":1}}'"
  {"X_PRPLWARE-COM_Controller.Network.AccessPoint.1.":{"Enable":true}}
  {}
  {"amxd-error-code":0}
...
Create second instance of Network.AccessPoint for guest VAPs:
  ...
  $ R "ubus -S call X_PRPLWARE-COM_Controller.Network.AccessPoint _add"
  {"object":"X_PRPLWARE-COM_Controller.Network.AccessPoint.2.","index":2,"name":"2","parameters":{},"path":"X_PRPLWARE-COM_Controller.Network.AccessPoint.2."}
  {}
  {"amxd-error-code":0}
  $ R "ubus -S call X_PRPLWARE-COM_Controller.Network.AccessPoint.2 _set '{\"parameters\":{\"Band2_4G\":1,\"Band5GH\":1,\"Band5GL\":1,\"Band6G\":1}}'"
  {"X_PRPLWARE-COM_Controller.Network.AccessPoint.2.":{"Band5GH":true,"Band6G":true,"Band5GL":true,"Band2_4G":true}}
  {}
  {"amxd-error-code":0}

  $ R "ubus -S call X_PRPLWARE-COM_Controller.Network.AccessPoint.2 _set '{\"parameters\":{\"MultiApMode\":\"Fronthaul\"}}'"
  {"X_PRPLWARE-COM_Controller.Network.AccessPoint.2.":{"MultiApMode":"Fronthaul"}}
  {}
  {"amxd-error-code":0}

  $ R "ubus -S call X_PRPLWARE-COM_Controller.Network.AccessPoint.2.Security _set '{\"parameters\":{\"ModeEnabled\":\"WPA2-Personal\",\"KeyPassphrase\":\"passwordGUEST\"}}'"
  {"X_PRPLWARE-COM_Controller.Network.AccessPoint.2.Security.":{"KeyPassphrase":"passwordGUEST","ModeEnabled":"WPA2-Personal"}}
  {}
  {"amxd-error-code":0}

  $ R "ubus -S call X_PRPLWARE-COM_Controller.Network.AccessPoint.2 _set '{\"parameters\":{\"SSID\":\"prplOSguest\"}}'"
  {"X_PRPLWARE-COM_Controller.Network.AccessPoint.2.":{"SSID":"prplOSguest"}}
  {}
  {"amxd-error-code":0}

In case the controller does not yet have this parameter, catch error here isof later during teardown test:
  $ R "ubus -S call X_PRPLWARE-COM_Controller.Network.AccessPoint.2 _set '{\"parameters\":{\"Enable\":1}}'"
  {"X_PRPLWARE-COM_Controller.Network.AccessPoint.2.":{"Enable":true}}
  {}
  {"amxd-error-code":0}
...
To disable wireless, disable instances of Network.AccessPoint{i} and call AccessPointCommit():
  ...
  $ R "ubus -S call X_PRPLWARE-COM_Controller.Network.AccessPoint.1 _set '{\"parameters\":{\"Enable\":0}}'"
  {"X_PRPLWARE-COM_Controller.Network.AccessPoint.1.":{"Enable":false}}
  {}
  {"amxd-error-code":0}

  $ R "ubus -S call X_PRPLWARE-COM_Controller.Network.AccessPoint.2 _set '{\"parameters\":{\"Enable\":0}}'"
  {"X_PRPLWARE-COM_Controller.Network.AccessPoint.2.":{"Enable":false}}
  {}
  {"amxd-error-code":0}
