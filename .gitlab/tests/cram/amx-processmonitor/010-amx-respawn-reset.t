...
Stop all the process
  $ R "service tr181-mqttbroker stop > /dev/null 2>&1"

  $ R "service tr181-pcp stop  > /dev/null 2>&1"

  $ R "service tr181-pcp stop  > /dev/null 2>&1"

  $ R "service deviceinfo-manager stop  > /dev/null 2>&1"

  $ R "service wan-manager stop  > /dev/null 2>&1"

  $ R "service dhcpv4-manager stop  > /dev/null 2>&1"

Start all the process
  $ R "service tr181-mqttbroker start  > /dev/null 2>&1"

  $ R "service tr181-pcp start  > /dev/null 2>&1"

  $ R "service tr181-pcp start  > /dev/null 2>&1"

  $ R "service deviceinfo-manager start  > /dev/null 2>&1"

  $ R "service wan-manager start  > /dev/null 2>&1"
