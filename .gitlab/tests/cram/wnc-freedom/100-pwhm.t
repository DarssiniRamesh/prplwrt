...
Suspend prplMesh processes:

  $ R "killall -SIGSTOP beerocks_agent"
  $ R "killall -SIGSTOP beerocks_fronthaul"
...
Resume prplMesh processes:
  ...
  $ R "killall -SIGCONT beerocks_agent"
  $ R "killall -SIGCONT beerocks_fronthaul"
